...
![](crossplot_img/CrossplotMainMenu.png)
...
Для сохранения кросс-плота достаточно нажать [ПКМ](../../terms/basics/ПКМ.md) в любом месте на графике и выбрать Save Plot (Сохранить график):
